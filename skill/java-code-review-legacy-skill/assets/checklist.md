# Java Code Review Checklist (Legacy)

Quick review checklist for Java 8 / Spring Boot 2 projects, sorted by priority.
...
## Java 8 Features (3 min)

- [ ] Lambda expressions not overly complex
- [ ] Stream API for pipelines (not simple loops)
