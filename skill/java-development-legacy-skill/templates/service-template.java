// Service Template - Business logic layer (Java 8)
...
public class SampleService {
    ...
    public SampleResponse create(CreateSampleRequest request) {
        ...
        SampleEntity sample = sampleMapper.toEntity(request);
    ...
    private void updateFields(SampleEntity sample, UpdateSampleRequest request) {
